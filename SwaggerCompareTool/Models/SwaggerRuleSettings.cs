namespace SwaggerCompareTool.Models
{
    ...
    public class SwaggerRuleSettings
    {
        ...
        public SwaggerErrorSeverity Info_Version { get; set; } = SwaggerErrorSeverity.Information;
        ...
        public SwaggerErrorSeverity Version_Mismatch { get; set; } = SwaggerErrorSeverity.Warning;

        public SwaggerErrorSeverity Breaking_Change { get; set; } = SwaggerErrorSeverity.Warning;
    }
}
